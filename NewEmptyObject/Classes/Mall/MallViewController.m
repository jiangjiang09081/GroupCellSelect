...
- (void)addSUb{
    _dataArr = @[@{@"image" : @"查看图片", @"name": @"查看图片", @"contentArr":@[@"正白光", @{@"subtitle" :@"紫外光", @"subArr":@[@"皱纹",@"光泽度",@"透明度",@"睫毛",@"轮廓"]}, @"偏振 (平行)", @"偏振 (交叉)", @"紫外线色斑", @{@"subtitle" :@"红色分析", @"subArr":@[@"皱纹",@"光泽度",@"透明度"]},@"棕色分析",@"综览图"]},
                 @{@"image" : @"成像对照",@"name": @"成像对照"},
                 @{@"image" : @"下载报告",@"name": @"下载报告", @"contentArr":@[@"综合报告", @"棕色分析", @"色斑", @"紫外线色斑", @"红色分析", @{@"subtitle" :@"毛孔", @"subArr":@[@"皱纹",@"光泽度",@"透明度",@"睫毛",@"轮廓"]}, @"皱纹",@"光泽度",@"透明度",@"睫毛",@"轮廓",@"平滑度",@"痤疮",@"唇纹"]},
